...
CONF_STATION_DAILY_INTERVAL = "station_daily_interval"
DEFAULT_OBSERVATION_INTERVAL = 600
DEFAULT_FORECAST_INTERVAL = 21600
DEFAULT_STATION_DAILY_INTERVAL = 3600
DEFAULT_INTERVALS = {
    CONF_OBSERVATION_INTERVAL: DEFAULT_OBSERVATION_INTERVAL,
    CONF_FORECAST_INTERVAL: DEFAULT_FORECAST_INTERVAL,
    CONF_STATION_DAILY_INTERVAL: DEFAULT_STATION_DAILY_INTERVAL,
}
